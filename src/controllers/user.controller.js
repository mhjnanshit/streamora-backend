...
const getWatchHistory = asyncHandler(async (req,res) => {
    const user = await  User.aggregate([
        {
          $match: {
           // _id: req.user._id  -> It will give problem kyuki baaki jagah mongoose string ko id mein convert kar deta hai , but pipelines ka code as it is hi jaata hai , so we need to conert string into id (Yes , hume req.user._id se string milti hai)
